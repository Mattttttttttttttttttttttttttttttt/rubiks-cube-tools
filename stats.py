...
r: list = []  # refined list (DNF as "DNF", in seconds, no "+")
...
AVG1 = check("avg1", "length of first average you want to calculate (default 5): ",
...
if AVG1:
    ...
    AVG1 = None
AVG2 = check("avg2", "length of second average you want to calculate (default 12): ",
                  [str(i) for i in (range(1, LENGTH + 1))], True)
if AVG2:
    AVG2 = int(AVG2)
elif LENGTH >= 12:
...
f"**best ao{AVG2}**:": AVG2,
"**standard deviation**:": ""}
CUT1_min: str = seconds(str(CUT1))
CUT2_min: str = seconds(str(CUT2))
CUT3_min: str = seconds(str(CUT3))
